...
- (NSArray*)sortingArrayByName:(NSArray*)array{
    ...
    NSArray* sortedArrayByName = [array sortedArrayUsingComparator:^NSComparisonResult(KStudent* obj1, KStudent* obj2) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([object isKindOfClass:[KGroup class]]) {
        ...
        cell.detailTextLabel.text = [NSString stringWithFormat:@"%.1f",student.score];
